            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-2 gap-12 sm:grid-cols-2 p-4 lg:grid-cols-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="space-y-1 text-white flex flex-col">
                            ...
                            <a href='/about' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                About us</a>
                            <a href='/faqs' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Faq's</a>
                            <a href='/' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Get the app</a>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="space-y-1 text-white flex flex-col">
                            <a href='/careers' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Careers</a>
                            <a href='/blogs' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Blog</a>
                            <a href='/help' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Help</a>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        ...
                        <div className="space-y-1 text-white flex flex-col">
                            <a href='/cookie-settings' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Cookie settings</a>
                            <a href='/privacy-policy' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Privacy Policy</a>
                            <a href='/terms' rel="noopener noreferrer" className="text-white no-underline hover:underline">
                                Terms</a>
                        </div>
                    </div>
                </div>
